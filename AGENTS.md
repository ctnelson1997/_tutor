# AGENTS.md — Project Instructions for Tutor

## Documentation Policy

When making codebase changes (new engines, scripts, store fields, utilities, architecture, dependencies, etc.), update **README.md** and **AGENTS.md** in the same commit to keep documentation current. Do not let docs fall out of date.
